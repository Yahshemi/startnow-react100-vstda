    ...
    return (
      <div className='AppMain'>
        <div className='container'>
          ...
          <h5 className='white'>Track all of the things</h5>
          <hr className='white' />
          {/* This calls the child component AddTodo and says, when the text changes, run handleText. */}
          <AddTodo handleText={this.handleText} changePriority={this.handlePriority} addItem={this.addItem} text={this.state.text} />
          <ViewTodo items={this.state.items} handleDelete={this.handleDelete} handleChange={this.handleChange} updateTodo={this.updateTodo} handleUpdating={this.handleUpdating} saveAndClose={this.saveAndClose}  />
