        ...
        {this.state.isEditing ? (
          <div>
            ...
            <select
              ...
              onChange={this.props.handleChange}
            >
              <option value="Select" className="create-todo-priority">
                Select a priority
              </option>
          ...
          >
            ...
            {
              <a
                className="delete-todo glyphicon glyphicon-trash pull-right ml-4 margin"
                href="#"
                onClick={() => this.passToHandleDelete()}
              />
            }
            <a
              className="edit-todo glyphicon glyphicon-edit pull-right ml-4"
              href="#"
              onClick={() => this.isEditingFunc()}
            />
          </div>
        )}
      </li>
